...
export default function StatusDetails() {
  ...
  return (
    <main className="border-4 border-transparent flex-[2] rounded-md p-4 text-slate-300">
      <div className="h-full font-museoModerno grid grid-cols-[3fr_1fr] text-right mx-auto md:grid-cols-2 col-start-1 col-span-6 md:col-start-4 md:col-span-3 gap-[5vh] row-start-3 row-span-2 md:row-start-3 md:row-span-3 px-10 content-around text-3xl lg:text-[3vw] text-slate-200">
        <span
